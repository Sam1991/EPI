...
--
-- Servidor: localhost
-- Tiempo de generación: 06-11-2014 a las 15:09:03
...
(1, NULL, NULL, 1415286132, 'admin', 'admin@tucorreo.com', 'admin', NULL, 1, 0, 0),
(2, NULL, NULL, NULL, 'invitado', 'invitado', 'nopassword', NULL, 1, 0, 0),
(4, 1415200361, 1415200361, 1415286116, '213213', 'dsfa@hotma.com', 'dsf', NULL, 1, 0, 0);
...
(21, '¿Sabías que la medida de tu cintura puede indicarte tu esperanza de vida?', 'Descubrimos Dieta y Más para mejorarla', 'Ya en 2012 la doctora Margaret Ashwell, investigadora en obesidad y riesgos asociados, explicaba en un artículo científico publicado en la revista especializada Obesity Reviews, la relación entre; el contorno de nuestra cintura y la esperanza de vida  En realidad, el conocido como índice cintura-estatura (ICE) es un indicador preciso de riesgo para la salud y de mortalidad porque traduce un aumento de grasa en el abdomen, que se asocia con una cintura mayor, y se relaciona con trastornos metabólicos como diabetes, hipertensión arterial, y dislipemias (alteración del metabolismo de los lípidos). No es de extrañar que en algunos países este índice se haya convertido hoy día en el principal indicador para hacerse un seguro de vida y el correspondiente pago de sus primas anuales. Por ejemplo, un hombre de 30 años con ICE demasiado alto puede llegar a ver reducida su esperanza de vida hasta en 17 años. Lo mismo ocurre en las mujeres, pudiendo llegar a ver mermada su esperanza de vida en más de 9 años.', 'dieta-y-mas.jpg');
